...
mod sistema {
    ...
    pub struct Sistema {
        ...
        datos_socios: Mapping<AccountId, Socio>,
        precio_a: u32,
        precio_b: u32,
        precio_c: u32,
    ...
    impl Sistema {
        ...
        fn new2(
            ...
            let datos_socios = Mapping::new();

            let owner = None;
            let politica_de_permisos = true;
            Sistema {
                registro_pagos,
                datos_socios,
                precio_a,
        ...
        pub fn default() -> Sistema {
            ...
            let datos_socios = Mapping::new();
            let owner = None;
            let politica_de_permisos = false;
            Sistema {
                registro_pagos,
                datos_socios,
                precio_a,
        ...
        fn agregar_socio2(
            ...
            let mut esta = false;
            if self.datos_socios.get(self.env().account_id()) == None {
                match InfoCat::new(cat.clone(), self, actividad) {
                    Ok(a) => {
                        ...
                        self.datos_socios.insert(self.env().account_id(), &socio);
        ...
        fn get_socio(&self, account: AccountId) -> Option<Socio> {
            self.datos_socios.get(account)
        }
        ///ver el proximo pago
        #[ink(message)]
