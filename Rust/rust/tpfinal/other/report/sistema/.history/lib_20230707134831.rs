...
mod sistema {
    ...
    impl Sistema {
        ...
        fn new2(
            ...
            let account32: AccountId32 =
                hex!["d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d"].into();
            let mut init_account32 = AccountId32::as_ref(&account32);
            let init_account: AccountId =
                AccountId::decode(&mut init_account32).unwrap_or_default();
        ...
        fn set_owner(&mut self) {
            self.owner = self.env().account_id();
        }
        #[ink(constructor)]
