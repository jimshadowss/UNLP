...
mod sistema {
    ...
    impl Sistema {
        ...
        ///set_porcentaje solo puede ser llamado por el owner, cambia la cantidad de pagos consecutivos requeridos para acceder al descuento
        #[ink(message)]
        ...
        ///set_porcentaje solo puede ser llamado por el owner, cambia el precio de la categoria A
        #[ink(message)]
        ...
        /// cambia el precio de la categoria B
        #[ink(message)]
