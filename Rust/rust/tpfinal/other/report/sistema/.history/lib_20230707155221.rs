...
mod sistema {
    ...
    impl Sistema {
        ...
        pub fn set_porcentaje2(&mut self, porcentaje: u32) -> Result<String, String> {
        ...
        pub fn get_porcentaje2(&self) -> Result<u32, String> {
            let res = self.check_permisos();
            match res {
                Ok(_) => Ok(self.porcentaje_descuento),
                Err(e) => Err(e),
            }
        }
        ...
        pub fn set_cantidad_pagos_consecutivos2(
            &mut self,
            cantidad_pagos_consecutivos: u8,
        ) -> Result<String, String> {
            let res = self.check_permisos();
