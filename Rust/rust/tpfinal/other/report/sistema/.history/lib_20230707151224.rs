...
mod sistema {
    ...
    use ink::storage::traits::ResolverKey;
    ...
    pub struct Sistema {
        ...
        socios_map: Mapping<AccountId, u32>,
    ...
    impl Sistema {
        ...
        pub fn default() -> Sistema {
            ...
            let datos_socios = Vec::new();
            let owner = None;
            let socios_map: Mapping<AccountId, u32, ResolverKey<AutoKey, ManualKey<2121635263>>> =
                Mapping::new();
        ...
        fn check_permisos(&self) -> Result<String, String> {
            if !self.permisos_privados || self.owner.unwrap() == self.env().account_id() {
                Ok("Correcto".to_string())
            } else {
                Err("No cuenta con los permisos requeridos".to_string())
            }
        }
        ...
        pub fn get_porcentaje(&self) -> Result<u32, String> {
            let res = self.check_permisos();
            match res {
                Ok(a) => Ok(self.porcentaje_descuento),
                Err(e) => Err(e),
            }
        }
        ...
        pub fn get_cantidad_pagos_consecutivos(&self) -> Result<u8, String> {
            let res = self.check_permisos();
            match res {
                Ok(a) => Ok(self.cantidad_pagos_consecutivos),
                Err(e) => Err(e),
            }
        }
        ...
        fn set_precio_a2(&mut self, precio_a: u32) {
        ...
        fn set_precio_b2(&mut self, precio_b: u32) {
        ...
        fn set_precio_c2(&mut self, precio_c: u32) {
